    ...
    <table id="table" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            <tr>
                ...
                <td>J.S.S One(1)</td>
                <td>     
                <div class="float"><a class="btn btn-default btn-primary" href="<?php echo e(url('analysis/view')); ?>">view</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/naijahacks2019-rema/resources/views/dashboard/analysis/index.blade.php ENDPATH**/ ?>